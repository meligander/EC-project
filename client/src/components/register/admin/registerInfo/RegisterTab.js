		...
		<div className='register register-tab'>
			...
			<table className='form'>
				<tbody>
					<tr>
						<td>Ingresos</td>
						<td>
							${register.temporary && register.income ? register.income : 0}
						</td>
						<td>
					...
					<tr>
						<td>Egresos</td>
						<td>
							${register.temporary && register.expence ? register.expence : 0}
						</td>
						<td>
			...
			<div className='btn-ctr pt-3'>
				<button
					...
					className={`btn ${!register.temporary ? 'btn-black' : 'btn-primary'}`}
				>
