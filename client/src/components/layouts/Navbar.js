...
import portrait from './../../img/logoSinFondo.png';
	...
	return (
		<nav className='navbar bg-primary'>
			...
			>
				...
				<p className='heading-navbar hide-sm'>Villa de Merlo English Center</p>
			</Link>
			{userLogged !== null && (
			...
			<div className={!showMenu ? 'menu' : 'menu show'}>
				<div className={!showMenu ? 'menu-branding' : 'menu-branding show'}>
					...
					<div className='address'>
						<h3 className='heading-tertiary'>Villa de Merlo English Center</h3>
					...
					<>
						{!loading ? (
							...
							<ul className={!showMenu ? 'menu-nav' : 'menu-nav show'}>
								<li
									className={!showMenu ? 'nav-item' : 'nav-item show current'}
								>
									<p className='lead'>
