...
export const ACTIVEUSERS_LOADED = "ACTIVEUSERS_LOADED";
...
export const OTHERVALUES_CLEARED = "OTHERVALUES_CLEARED";
...
export const ACTIVECLASSES_CLEARED = "ACTIVECLASSES_CLEARED";
...
export const NEWREGISTER_ADDED = "NEWREGISTER_ADDED";
export const REGISTER_CLOSED = "REGISTER_CLOSED";
export const NEWREGISTER_ALLOWED = "NEWREGISTER_ALLOWED";
...
export const YEARENROLLMENTS_CLEARED = "YEARENROLLMENTS_CLEARED";
export const ENROLLMENT_ERROR = "ENROLLMENT_ERROR";

//Assistance
export const ATTENDANCES_LOADED = "ATTENDANCES_LOADED";
export const STUDENTATTENDANCES_LOADED = "STUDENTATTENDANCES_LOADED";
...
export const STUDENTINSTALLMENTS_LOADED = "STUDENTINSTALLMENTS_LOADED";
...
export const STUDENTINSTALLMENTS_CLEARED = "STUDENTINSTALLMENTS_CLEARED";
export const TOTALDEBT_CLEARED = "TOTALDEBT_CLEARED";
...
export const UNSEENPOSTS_CHANGED = "UNSEENPOSTS_CHANGED";
export const ALLUNSEENPOSTS_CHANGED = "ALLUNSEENPOSTS_CHANGED";
